...
export default function CreateCreditNote(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(BACKEND_SERVER + "/getDocMaster/CreditNote", {
        //change
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
    ...
    axios
      ...
      .then(function (response) {
        ...
        if (response != null && response.data.res == "success") {
          ...
          Swal.fire(
            "",
            "Credit Note created successfully!", //change
            "success"
          );
          ...
          e.target.style.opacity = "";
          alert(
            "There is some issue in creating Credit Note. kindly check whether all the data is entered or not."
          ); //change
        }
      })
      .catch(function (error) {
        ...
        if (response != null && response.data.res == "success") {
          ...
          axios
            ...
            .then((res) => {
              ...
              window.location.href = "/viewCreditNote?invNo=" + res.data; //change
            });
          setIsSaved(1);
        } else {
          e.target.style.pointerEvents = ""; // Re-enable pointer events
          ...
          Swal.fire(
            "",
            "There is some issue in creating Credit Note.", //change
            "error"
          );
        }
      })
