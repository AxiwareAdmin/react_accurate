...
export default function ViewCreditNoteTriplet() {
  ...
  return (
    ...
    <div ref={invoicepdf}>
      ...
      <ViewQuotation invoiceType={fetchInvoiceType()} id={fetchId()} setInvoiceNumber={setInvoiceNumber} productTableId="productTable1" gstContainerId="gstContainer1" label="Original"/>
      <ViewQuotation invoiceType={fetchInvoiceType()} id={fetchId()} productTableId="productTable2" gstContainerId="gstContainer2" label="Duplicate"/>
      <ViewQuotation invoiceType={fetchInvoiceType()} id={fetchId()} productTableId="productTable3" gstContainerId="gstContainer3" label="Tripicate"/>
      </div>
   ...
   console.log("viewInvoicce:invoieType::"+props.invoiceType)
    ...
    useEffect(() => {
      ...
      if (!initilized.current) {
        ...
        axios
          .get(`${process.env.REACT_APP_LOCAL_URL}/viewCreditNote?invId=` + quoId, header)//debit note change
          .then((res) => {
            ...
            // if ((discnt != null && discnt != undefined && discnt != "") && (otherDiscount != null && otherDiscount != undefined && otherDiscount != ""))
                      ...
                      <div class="row">
                        ...
                        >
                          <div class="invoice-item-box">
                            <p>Delivery Challan No. : {invNo}</p>
                            <p class="mb-0">Delivery Challan Date : {invoiceDate}</p>
                          </div>
  
                          <div class="invoice-item-box">
                            <p>Invoice No. : {poNum}</p>
                            <p class="mb-0">Invoice Date : {poDate}</p>
                          </div>
                        </div>
                      </div>
                    </div>
