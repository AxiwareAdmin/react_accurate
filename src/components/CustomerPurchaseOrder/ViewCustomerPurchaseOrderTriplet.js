...
export default function ViewCustomerPurchaseOrderTriplet() {
   ...
   console.log("viewInvoicce:invoieType::"+props.invoiceType)
    ...
    useEffect(() => {
      ...
      if (!initilized.current) {
        ...
        axios
          .get(`${process.env.REACT_APP_LOCAL_URL}/viewCustomerPo?invId=` + quoId, header)
          .then((res) => {
