  ...
  const navigate=useNavigate();
    ...
    useEffect(() =>{
      ...
      useEffect(() =>{
        ...
        axios.post(`${process.env.REACT_APP_LOCAL_URL}/viewSalesRegDebitNote`,{financialYear:localStorage.getItem("financialYear")},header).then((res) =>{//debit note change
        ...
        res.data && res.data.map(ele => {
            ...
            let obj = JSON.parse(ele);
              ...
              aEle.href = `/debitNoteList?month=${obj.month}`;//debit note change
            ...
            <div class="content container-fluid">
                ...
                <div class="crms-title row bg-white">
                    <div class="col  p-0">
                        ...
                        </span>Debit Note Register </h3>
                    </div>
                    <div class="col p-0 text-end">
                        <ul class="breadcrumb bg-white float-end m-0 ps-0 pe-0">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Debit Note Register</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col text-end">
                            <ul class="list-inline-item ps-0">
                                ...
                                <li class="list-inline-item">
                                    <Link class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" to={`/CreateDebitNote`}>Create Debit Note</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
