							...
							<div className="col">
								<ul className="breadcrumb invoices-breadcrumb">
									<li className="breadcrumb-item invoices-breadcrumb-item">
										<a href="invoices.html">
											<i className="fa fa-chevron-left"></i> Back to Invoice List
										</a>
									</li>
								</ul>
							</div>
							 <div className="col-auto">
								<div className="invoices-create-btn">
									<a className="invoices-preview-link" href="#" data-bs-toggle="modal" data-bs-target="#invoices_preview"><i className="fa fa-eye"></i> Preview</a>
													 ...
													 <div className="form-group">
														...
														<div className="multipleSelection">
															<div className="selectBox">
																...
																<span className="down-icon"><i data-feather="chevron-down"></i></span>
															</div>						  
													...
													<tbody>
														<tr className="add-row">
															...
															<td className="add-remove text-end">
																<a href="javascript:void(0);" className="add-btns me-2"><i className="fas fa-plus-circle"></i></a> 
																<a href="#" className="copy-btn me-2"><i className="fas fa-copy"></i></a>
																<a href="javascript:void(0);" className="remove-btn"><i className="fa fa-trash-alt"></i></a>
															</td>
														</tr>
													</tbody>
												</table>
													...
													<div className="invoice-total-box">
														<div className="invoice-total-inner">
															...
															<p>Round Off 
																...
																<label htmlFor="status_1" className="checktoggles">checkbox</label> 
																<span>$54</span>
															</p>
															...
															<a href="javascript:void(0);" className="add-links1">
