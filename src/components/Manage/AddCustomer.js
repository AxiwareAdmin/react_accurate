            ...
            <div class="modal-content" >
                ...
                <div class="modal-header" style={{ backgroundColor: "#eee" }}>
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" onClick={() => {props.sendToParent({custId : null,flag : false,custName : null})}}>×</span>
                    </button>
                        ...
                        <div id="ContentPlaceHolder1_UpdatePanel2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" >
                                    ...
                                    <br />
                                     <label style={{visibility:'hidden'}}>Same as billing Address </label>
                                    <input  type="checkbox"  onclick="javascript:setTimeout('__doPostBack(\'ctl00$ContentPlaceHolder1$checkbox1\',\'\')', 0)" style={{display:'none'}}/>
                ...
                <button type="button" onClick={() => {props.sendToParent({custId : null,flag : false,custName : null})}} class="btn btn-danger" style={{float: "right", marginRight:"5px"}}>Close</button>
                </div>
