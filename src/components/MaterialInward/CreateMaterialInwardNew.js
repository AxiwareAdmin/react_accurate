...
export default function CreateMaterialInward(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(BACKEND_SERVER + "/getDocMaster/MaterialInward", {
        //change
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
    ...
    axios
      ...
      .then(function (response) {
        ...
        if (response != null && response.data.res == "success") {
          ...
          Swal.fire(
            "",
            "Material Inward created successfully!", //change
            "success"
          );
          ...
          e.target.style.opacity = "";
          alert(
            "There is some issue in creating Material Inward. kindly check whether all the data is entered or not."
          ); //change
        }
      })
      .catch(function (error) {
    ...
    axios
      ...
      .then(function (response) {
        ...
        if (response != null && response.data.res == "success") {
          ...
          let module = "MaterialInward";//change
          axios
            .post(
            ...
            .then((res) => {
              ...
              window.location.href = "/ViewMaterialInward?invNo=" + res.data; //change
            });
          setIsSaved(1);
        } else {
          e.target.style.pointerEvents = ""; // Re-enable pointer events
          ...
          Swal.fire(
            "",
            "There is some issue in creating Material Inward.", //change
            "error"
          );
        }
      })
                  ...
                  <ul className="breadcrumb invoices-breadcrumb">
                    <li className="breadcrumb-item invoices-breadcrumb-item">
                      <a href="invoices.html">
                        <i className="fa fa-chevron-left"></i> Back to Material Inward
                        List
                      </a>
                    </li>
                  </ul>
                                ...
                                Material Inward No.{" "}
                                  {invoiceMode == "Auto" ? (
                                    ...
                                    <input
                                      ...
                                      type="text"
                                      placeholder="Enter Material Inward Number"
                                      value={invoiceNumber}
