...
export default function AllQuotation () {
    ...
    useEffect(() =>{
      ...
      useEffect(() =>{
        ...
        var tempTotal=0;
        axios.get("http://localhost:8080/viewSalesRegquotation",header).then((res) =>{
            res.data.map(ele => {
        ...
        axios.get("http://localhost:8080/viewSalesRegquotation",header).then((res) =>{
          ...
          res.data.map(ele => {
            ...
            let obj = JSON.parse(ele);
              ...
              aEle.href = "/ViewQuotationByMonth?month="+obj.month;
                ...
                <div class="crms-title row bg-white">
                    ...
                    <div class="col p-0 text-end">
                        <ul class="breadcrumb bg-white float-end m-0 ps-0 pe-0">
                            <li class="breadcrumb-item"><Link to="/CreateQuotation" >Create Quotation</Link></li>
