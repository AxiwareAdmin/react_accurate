                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="invoice-head">
                        <h2>Quotation</h2>
                        <p>Quotation Number : {invNo}</p>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="invoice-info">
                        <strong class="customer-text-one">Quotation From</strong>
                  ...
                  <div class="row">
                   {serviceCheck=='false' &&<div class="col-md-6">
                      <div class="invoice-info" style={billToAddrShow ? {display:"none"} : {display : "block"}}>
                        ...
                        <strong class="customer-text-one">Customer Name :</strong>
                    ...
                    <div class={`col-md-${serviceCheck=='false'?6:12}`}>
                      <div class="invoice-info invoice-info2">
                        ...
                        <strong class="customer-text-one">Company's Bank Details</strong> 
                        <p class="invoice-details"/>
                          Debit Card <br/>
