...
export default function CreateQuotation(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(process.env.REACT_APP_LOCAL_URL + "/getDocMaster/Quotation", {
        //change
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
      ...
      .then((res) => {
        ...
        axios
          .get(
            process.env.REACT_APP_LOCAL_URL +
              `/Quotations/year/` +
              document.querySelector("#financialYear").value,
            {
              //change
              headers: {
                "Content-Type": "application/json",
    ...
    axios
      .get(process.env.REACT_APP_LOCAL_URL + "/gstRates", {
        headers: {
          Authorization: "Bearer " + token,
        },
      })
    ...
    axios
      .get(process.env.REACT_APP_LOCAL_URL + "/customers", {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
        },
    ...
    var token = localStorage.getItem("token");
    axios
      .get(process.env.REACT_APP_LOCAL_URL + "/invoiceproducts", {
        //change
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
  ...
  function onCopyInvoiceAddInvoiceDetails() {
    if (editref.current) {
      ...
      if (actionedit == "Edit" || actionedit == "Clone") {
        ...
        axios
          .get(
            `${process.env.REACT_APP_LOCAL_URL}/viewQuotation?invId=${invNoEdit}`,
            {
              //change
              headers: {
                "Content-Type": "application/json",
