    ...
    useEffect(() => {
      ...
      useEffect(() => {
          ...
          if(!initilized.current){  
            ...
            axios
            .get("http://localhost:8080/purchase/"+id1,header)
            .then((res) => {
        ...
        //   setToAddr(billingaddr);
          ...
          let custName = res.data.supplierName;
          if(custName != null && custName != undefined && custName != "")
          setcustName(custName);
          
          let fromaddr1 = res.data.address;
        ...
        //   setcmpName(toCustName);
          ...
          let tIssueDate = res.data.purchaseDate;
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="invoice-head">
                        <h2>Purchase</h2>
                        <p>Purchase Number : {invNo}</p>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="invoice-info">
                        <strong class="customer-text-one">Purchase From</strong>
