...
export default function ViewInvoice() {
  ...
  useEffect(() => {
    ...
    if (!initilized.current) {
      ...
      axios
        .get(`${process.env.REACT_APP_LOCAL_URL}/purchase/id/${invId}`, header)
        .then((res) => {
          debugger;

          setInvoiceDetails(res.data);

          setinvNo(res.data.purchaseNo);

          setInvoiceDate(getFormattedDate(new Date(res.data.purchaseDate)));
          ...
          let tempCustName = res.data.supplierName;
          ...
          res.data.purchaseProductDOs.map((ele) => {
         ...
         addGstElems(
          ...
          if (
            ...
            setTimeout(function () {
              downloadpdf(res.data.purchaseNo);
            }, 500);
          }
          ...
          if (
            ...
            setTimeout(function () {
              sendMail(res.data.purchaseNo,custName);
            }, 1500);
          }
